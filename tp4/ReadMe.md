...
```sql
GRANT CREATE PROCEDURE, CREATE VIEW, CREATE SEQUENCE, CREATE SESSION, CREATE TABLE, SELECT ANY TABLE, ALTER ANY TABLE, DROP ANY TABLE TO dev1;
```
...
```sql
 REVOKE CREATE PROCEDURE, CREATE VIEW, CREATE SEQUENCE, CREATE SESSION, CREATE TABLE, SELECT ANY TABLE, ALTER ANY TABLE, DROP ANY TABLE from dev1;
```
...
```sql
REVOKE ALL PRIVILEGES FROM DevSecOpsTeam;
